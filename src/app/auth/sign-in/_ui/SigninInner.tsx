...
export default function SigninInner(props: { enableSignup: boolean }) {
  ...
  return (
    <Form action={dispatchSignin}>
      <Stack spacing={1} sx={{ padding: 1 }}>
        ...
        {props.enableSignup && <Button variant="outlined" LinkComponent={NextLink} href="/auth/sign-up">Sign-Up Instead?</Button>}
